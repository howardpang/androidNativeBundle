...
- android gradle plugin 3.0.0 - 7.3.0
...
## Usage
### 1.Edit your root *build.gradle* file, add  *classpath 'io.github.howardpang:androidNativeBundle:1.1.2'* to the file
    buildscript {
        repositories {
            google()
            mavenCentral()
        ...
        dependencies {
            ...
            classpath "io.github.howardpang:androidNativeBundle:1.1.2"
        }
    }
