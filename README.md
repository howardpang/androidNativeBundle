...
## Usage
### 1.Edit your root *build.gradle* file, add  *classpath 'com.ydq.android.gradle.build.tool:nativeBundle:1.0.2'* to the file
    buildscript {
        repositories {
            jcenter()
            google()
        ...
        dependencies {
            ...
            classpath 'com.ydq.android.gradle.build.tool:nativeBundle:1.0.2'
        }
    }
